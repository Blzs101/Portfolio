...
export default function Home() {
  ...
  return (
    <main className="fixed flex flex-col items-center justify-center w-full font-bold h-3/4">
      ...
      <Link href="/Info" className="py-2 px-4  rounded-full cursor-pointer md:px-4 md:py-2 bg-slate-600 bg-opacity-30 hover:bg-opacity-50">{language === "EN" ? "Learn More" : "Még több"}</Link>
    </main>
  )
}
